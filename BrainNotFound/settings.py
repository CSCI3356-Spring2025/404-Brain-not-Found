...
SECRET_KEY = 'django-insecure-mj_gukr95a$$1pt8ydutuu%pumhhtdy%3_oh0_4k$(pz+1xv7f'
...
ROOT_URLCONF = 'BrainNotFound.urls'
...
EMAIL_HOST_USER = config('EMAIL_HOST_USER', default='mirabeev@bc.edu')
#EMAIL_HOST_PASSWORD = config('EMAIL_HOST_PASSWORD')
EMAIL_HOST_PASSWORD = config('EMAIL_HOST_PASSWORD', default='srqb gzqn sdpn pngr')
EMAIL_USE_TLS = True
EMAIL_USE_SSL = False
